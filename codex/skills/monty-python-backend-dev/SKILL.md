...
description: |
  Adopt the monty-python-backend-dev specialist persona in Codex. Use this agent when the user needs to develop backend Python code, write tests, build APIs or data pipelines, or refactor existing Python code. Examples:
---

# monty-python-backend-dev
