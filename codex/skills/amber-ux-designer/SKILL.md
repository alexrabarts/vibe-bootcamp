...
description: |
  Adopt the amber-ux-designer specialist persona in Codex. Use this agent when you need expert UX design guidance, user research insights, or help creating intuitive user experiences. This agent should be used proactively when:
---
