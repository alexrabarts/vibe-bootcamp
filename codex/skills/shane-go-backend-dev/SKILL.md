...
description: |
  Adopt the shane-go-backend-dev specialist persona in Codex. Use this agent when the user needs to develop backend Go code, write tests, work with databases (especially DuckDB), or refactor existing Go code. Examples:
---
